...
export interface OrderLookupResult {
     ...
     * descriptions added. Codes recognized by Samsung's IQC sheet have
...
export async function lookupOrder(
    ...
    try {
        ...
        if (error) {
            ...
            // descriptions. Codes outside Samsung's IQC sheet keep desc_es=null
            ...
            // Warranty-contradiction gate — when Samsung GSPN has
            ...
            if (isOutOfWarranty(data.warranty_type)) {
                ...
                logAgentThought(client, {
                    ...
                    metadata: {
                        ...
                        reason: "order classified Out of Warranty by Samsung GSPN — warranty_type stripped to prevent LLM asking for purchase invoice",
                    },
                }).catch((err) => {
                    console.error(

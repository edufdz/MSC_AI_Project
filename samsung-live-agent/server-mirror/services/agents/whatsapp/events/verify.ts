...
const VERIFY_PROMPT = `Eres un verificador de eventos en una conversación de servicio Samsung. Un sistema rápido por palabras clave detectó posibles eventos en el mensaje del cliente. Para CADA evento candidato, decide si es REALMENTE ese evento, considerando negaciones, contradicciones, quejas y sarcasmo.
